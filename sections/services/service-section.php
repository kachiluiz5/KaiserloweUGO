                        ...
                        <div class="service-item-inner">
                            ...
                            <div class="service-content">
                                <div class="service-icon">
                                    <i class="ci ci-bulldozer"></i>
                                </div>
                                <h3>Project Development</h3>
                                <p>From land to Building – We develop a round concept, plan and organize the implementation.</p>
                ...
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="service-item wow fade-in-bottom" data-wow-delay="400ms">
                        <div class="service-item-inner">
                            ...
                            <div class="service-content">
                                <div class="service-icon">
                                    <i class="ci ci-excavators"></i>
                                </div>
                                <h3>Planning and Building</h3>
                                <p>Are you seeking a partner for property development and building? Look no further than Kaiserlowe UGO LTD.</p>
                                <!-- <a class="read-more" href="service-details.html">Read More</a> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="service-item wow fade-in-bottom" data-wow-delay="600ms">
                        <div class="service-item-inner">
                            ...
                            <div class="service-content">
                                <div class="service-icon">
                                    <i class="ci ci-water-system"></i>
                                </div>
                                <h3>Energy</h3>
                                <p>Kaiserlowe UGO is known for better Energy building, Powerstation, Solarenergy, Windenergy, etc.</p>
                                <!-- <a class="read-more" href="service-details.html">Read More</a> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="service-item wow fade-in-bottom" data-wow-delay="800ms">
                        <div class="service-item-inner">
                            ...
                            <div class="service-content">
                                <div class="service-icon">
                                    <i class="ci ci-paint-brush"></i>
                                </div>
                                <h3>Real Estate</h3>
                                <p>With Kaiserlowe UGO you are at the safe side…. Trust is the most important thing to build up a successful cooperation.</p>
                                <!-- <a class="read-more" href="service-details.html">Read More</a> -->
                            </div>
                        </div>
                    </div>
